...
```{r, echo = FALSE, fig.height = 1.9, fig.width = column_width, fig.cap = "Two main gradients of climatic variation across Queensland, Australia. Polygons denote planning units."}
# prepare data
...
```{r, echo = FALSE, fig.height = 3.8, fig.width = column_width, fig.cap = "Distribution of the species used in the first case study. Polygons denote planning units. Planning units occupied by a given species are shown in light blue."}
# prepare data
...
p2 <- ggplot2::ggplot() +
  ...
  ggplot2::theme(
    ...
    legend.background = ggplot2::element_rect(size = ggplot2::unit(0.25,
                                                                  "mm"))) +
