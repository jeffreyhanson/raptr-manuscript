...
```{r, echo=FALSE, messages=FALSE, results='hide', fig.height=1.6, fig.width=column.width, fig.cap='Distributions of three simulated species. Squares denote planning units. Colors indicate probability of occupancy.'}
# prepare data
...
```{r, echo=FALSE, fig.height=3.5, fig.width=2*column.width, fig.cap=paste0('Prioritizations for the simulation study. Each panel shows a prioritization generated for a single species using a set of parameters. Squares denote planning units. Planning units shown in dark green units were selected for protection. Each row of panels show prioritizations generated for a different species. Each column of panels corresponds to a different set of parameters used to generate the prioritization.')}
# prepare data
...
```{r, echo=FALSE, fig.height=1.9, fig.width=column.width, fig.cap='Distribution of climatic variation across Queensland, Australia. Squares denote planning units. Panels show the two main gradients of climatic variation.'}
# prepare data
cs1.pca.FPTS <- ldply(
...
```{r, echo=FALSE, fig.height=3.8, fig.width=column.width, fig.cap='Distribution of the species used in the first case study. Each panel shows the geographic range for a different species. Squares denote planning units.'}
# prepare data
...
```{r, echo=FALSE, fig.height=1.9, fig.width=column.width, fig.cap=paste0('Prioritizations for the first case study. See Fig. 3 caption for conventions. Panel (a) shows the planning units selected when using ',cs1.params.LST[[MODE]]$amount.target*100,' % amount targets. Panel (b) shows the planning units selected when using ',cs1.params.LST[[MODE]]$amount.target*100,' % amount targets and ',cs1.params.LST[[MODE]]$space.target*100,' % niche targets.')}
# prepare data
