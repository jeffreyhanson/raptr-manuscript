...
```{r, echo=FALSE, fig.height=1.6, fig.width=column.width, fig.cap='Distribution of environmental variation across Queensland, Australia. Squares denote planning units. Panels show the two main gradients of climatic variation.'}
# prepare data
cs1.pca.FPTS <- ldply(
...
```{r, echo=FALSE, fig.height=2.35, fig.width=column.width, fig.cap='Distribution of the species used in the first case study. Each panel shows a different species. Squares denote planning units. Planning units occupied by a species are shown in bright blue.'}
# prepare data
...
```{r, echo=FALSE, fig.height=1.175, fig.width=column.width, fig.cap=paste0('Prioritizations for the first case study. Squares represent planning units. Dark green planning units were selected for protection. Panel (a) shows the planning units selected when using ',cs1.params.LST[[MODE]]$amount.target*100,' % amount targets. Panel (b) shows the planning units selected when using ',cs1.params.LST[[MODE]]$amount.target*100,' % amount targets and ',cs1.params.LST[[MODE]]$space.target*100,' % niche targets.')}
# prepare data
