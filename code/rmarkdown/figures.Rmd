...
```{r, echo=FALSE, fig.height=4.5, fig.width=4.0, fig.cap='Species used in the first case-study. Squares denote planning units. Each panel shows the distribution of a given species. For a given species, planning units inhabited by the species are shown in bright blue and those uninhabited are shown in dark blue.'}
# prepare data
...
```{r, echo=FALSE, fig.height=4.5, fig.width=4.5, fig.cap=paste0('Study area for the second case-study. Squares denote planning units. Panel (a) shows the planning units occupied by ',cs2.params.LST[[MODE]]$common.name,'. Panels (b--c) show the spatial distribution of the ordinated values that describe patterns of genetic variation associated this species.')}
...
```{r, echo=FALSE, fig.height=5, fig.width=5, fig.cap=paste0('Prioritisations for the genetic case-study in the European Alps. Panel (a) shows the planning units selected when using ',cs2.params.LST[[MODE]]$amount.target*100,' % amount targets. Panel (b) shows the planning units selected selected when using ',cs2.params.LST[[MODE]]$amount.target*100,' % amount targets and ',cs2.params.LST[[MODE]]$genetic.target*100,' % genetic targets. The conventions for panels (a--b) are detailed in the caption for Figure 7. Panels (c--d) show the solutions in the genetic space. In these panels, each point is an average of the ordinations for individuals in each planning unit. Each point represents the typical genetic characeristics of individuals sampled in a given planning unit (based on an NMDS of the binary loci data). Planning units associated with points that are closer togeather contain individuals with more similar genetic characteristics than planning units that are further apart. Dark green planning units were selected for protection, and pale green planning units were discarded.')}
